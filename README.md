...
Create a paginated data list table that displays person's first name, last name, age, status, and visits. User should be able to filter table, sort columns, edit table information. Data should be randomly generated.
...
Live Website: https://javascript-react-people-list.herokuapp.com/
